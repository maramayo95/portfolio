...
const PalmTreeIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" preserveAspectRatio="xMidYMid" viewBox="0 0 256 229">
...
const FlowerIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" width="1.8em" height="1.8em">
        <defs>
...
export default function Stack() {
  return (
    <div className="w-full flex items-center justify-center font-sans p-8 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto flex items-center justify-end">
            <IconGrid />
        </div>
    </div>
  );
