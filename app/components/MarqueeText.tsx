...
const LinearLoop: FC<LinearLoopProps> = ({
  ...
  return (
    ...
    >
      <svg
        className="select-none w-full overflow-visible block text-[4rem] font-bold tracking-[5px]  leading-none"
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="100%" stopColor="#9333EA" /> {/* to-purple-600 */}
          </linearGradient>
        </defs>
        {/* Render the visible text only when measurements are ready */}
        {ready && (
          <text xmlSpace="preserve" fill={`url(#${uid}-gradient)`}>
